...
import "github.com/gomlx/gopjrt/proto"
...
func (dtype DType) PrimitiveType() proto.PrimitiveType {
	switch dtype {
	case InvalidDType:
		return proto.PrimitiveType_PRIMITIVE_TYPE_INVALID
	case Bool:
		return proto.PrimitiveType_PRED
	case Int8:
		return proto.PrimitiveType_S8
	case Int16:
		return proto.PrimitiveType_S16
	case Int32:
		return proto.PrimitiveType_S32
	case Int64:
		return proto.PrimitiveType_S64
	case Uint8:
		return proto.PrimitiveType_U8
	case Uint16:
		return proto.PrimitiveType_U16
	case Uint32:
		return proto.PrimitiveType_U32
	case Uint64:
		return proto.PrimitiveType_U64
	case Float16:
		return proto.PrimitiveType_F16
	case Float32:
		return proto.PrimitiveType_F32
	case Float64:
		return proto.PrimitiveType_F64
	case BF16:
		return proto.PrimitiveType_BF16
	case Complex64:
		return proto.PrimitiveType_C64
	case Complex128:
		return proto.PrimitiveType_C128
	case F8E5M2:
		return proto.PrimitiveType_F8E5M2
	case F8E4M3FN:
		return proto.PrimitiveType_F8E4M3FN
	case F8E4M3B11FNUZ:
		return proto.PrimitiveType_F8E4M3B11FNUZ
	case F8E5M2FNUZ:
		return proto.PrimitiveType_F8E5M2FNUZ
	case F8E4M3FNUZ:
		return proto.PrimitiveType_F8E4M3FNUZ
	case S4:
		return proto.PrimitiveType_S4
	case U4:
		return proto.PrimitiveType_U4
	case TOKEN:
		return proto.PrimitiveType_TOKEN
	case S2:
		return proto.PrimitiveType_S2
	case U2:
		return proto.PrimitiveType_U2
	default:
		return proto.PrimitiveType_PRIMITIVE_TYPE_INVALID
	}
}
...
func FromPrimitiveType(primitiveType proto.PrimitiveType) DType {
	...
	case proto.PrimitiveType_PRIMITIVE_TYPE_INVALID:
		return InvalidDType
	case proto.PrimitiveType_PRED:
		return Bool
	case proto.PrimitiveType_S8:
		return Int8
	case proto.PrimitiveType_S16:
		return Int16
	case proto.PrimitiveType_S32:
		return Int32
	case proto.PrimitiveType_S64:
		return Int64
	case proto.PrimitiveType_U8:
		return Uint8
	case proto.PrimitiveType_U16:
		return Uint16
	case proto.PrimitiveType_U32:
		return Uint32
	case proto.PrimitiveType_U64:
		return Uint64
	case proto.PrimitiveType_F16:
		return Float16
	case proto.PrimitiveType_F32:
		return Float32
	case proto.PrimitiveType_F64:
		return Float64
	case proto.PrimitiveType_BF16:
		return BF16
	case proto.PrimitiveType_C64:
		return Complex64
	case proto.PrimitiveType_C128:
		return Complex128
	case proto.PrimitiveType_F8E5M2:
		return F8E5M2
	case proto.PrimitiveType_F8E4M3FN:
		return F8E4M3FN
	case proto.PrimitiveType_F8E4M3B11FNUZ:
		return F8E4M3B11FNUZ
	case proto.PrimitiveType_F8E5M2FNUZ:
		return F8E5M2FNUZ
	case proto.PrimitiveType_F8E4M3FNUZ:
		return F8E4M3FNUZ
	case proto.PrimitiveType_S4:
		return S4
	case proto.PrimitiveType_U4:
		return U4
	case proto.PrimitiveType_TOKEN:
		return TOKEN
	case proto.PrimitiveType_S2:
		return S2
	case proto.PrimitiveType_U2:
		return U2
	default:
		return InvalidDType
	}
