...
import "github.com/gomlx/gopjrt/protos"
...
func (dtype DType) PrimitiveType() protos.PrimitiveType {
	switch dtype {
	case InvalidDType:
		return protos.PrimitiveType_PRIMITIVE_TYPE_INVALID
	case Bool:
		return protos.PrimitiveType_PRED
	case Int8:
		return protos.PrimitiveType_S8
	case Int16:
		return protos.PrimitiveType_S16
	case Int32:
		return protos.PrimitiveType_S32
	case Int64:
		return protos.PrimitiveType_S64
	case Uint8:
		return protos.PrimitiveType_U8
	case Uint16:
		return protos.PrimitiveType_U16
	case Uint32:
		return protos.PrimitiveType_U32
	case Uint64:
		return protos.PrimitiveType_U64
	case Float16:
		return protos.PrimitiveType_F16
	case Float32:
	...
	case Complex128:
		return protos.PrimitiveType_C128
	case F8E5M2:
		return protos.PrimitiveType_F8E5M2
	case F8E4M3FN:
		return protos.PrimitiveType_F8E4M3FN
	case F8E4M3B11FNUZ:
		return protos.PrimitiveType_F8E4M3B11FNUZ
	case F8E5M2FNUZ:
		return protos.PrimitiveType_F8E5M2FNUZ
	case F8E4M3FNUZ:
		return protos.PrimitiveType_F8E4M3FNUZ
	case S4:
		return protos.PrimitiveType_S4
	case U4:
		return protos.PrimitiveType_U4
	case TOKEN:
		return protos.PrimitiveType_TOKEN
	case S2:
		return protos.PrimitiveType_S2
	case U2:
		return protos.PrimitiveType_U2
	default:
		return protos.PrimitiveType_PRIMITIVE_TYPE_INVALID
	}
}
...
// It is unfortunate, but the data types enums used in PJRT (which DType is modeled after)
// and C++ XlaBuilder (and other parts of XLA) don't match.
func FromPrimitiveType(primitiveType protos.PrimitiveType) DType {
	switch primitiveType {
	case protos.PrimitiveType_PRIMITIVE_TYPE_INVALID:
		return InvalidDType
	case protos.PrimitiveType_PRED:
		return Bool
	case protos.PrimitiveType_S8:
		return Int8
	case protos.PrimitiveType_S16:
		return Int16
	case protos.PrimitiveType_S32:
		return Int32
	case protos.PrimitiveType_S64:
		return Int64
	case protos.PrimitiveType_U8:
		return Uint8
	case protos.PrimitiveType_U16:
		return Uint16
	case protos.PrimitiveType_U32:
		return Uint32
	case protos.PrimitiveType_U64:
		return Uint64
	case protos.PrimitiveType_F16:
		return Float16
	case protos.PrimitiveType_F32:
		return Float32
	...
	case protos.PrimitiveType_C128:
		return Complex128
	case protos.PrimitiveType_F8E5M2:
		return F8E5M2
	case protos.PrimitiveType_F8E4M3FN:
		return F8E4M3FN
	case protos.PrimitiveType_F8E4M3B11FNUZ:
		return F8E4M3B11FNUZ
	case protos.PrimitiveType_F8E5M2FNUZ:
		return F8E5M2FNUZ
	case protos.PrimitiveType_F8E4M3FNUZ:
		return F8E4M3FNUZ
	case protos.PrimitiveType_S4:
		return S4
	case protos.PrimitiveType_U4:
		return U4
	case protos.PrimitiveType_TOKEN:
		return TOKEN
	case protos.PrimitiveType_S2:
		return S2
	case protos.PrimitiveType_U2:
		return U2
	default:
		return InvalidDType
	}
