...
func (x *AutotuneResult) GetCustomKernelFusion() *AutotuneResult_CustomKernelFusionKey {
	if x, ok := x.GetKey().(*AutotuneResult_CustomKernelFusion); ok {
...
func file_xla_autotuning_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_xla_autotuning_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*AutotuneResult_CustomKernelFusionKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
